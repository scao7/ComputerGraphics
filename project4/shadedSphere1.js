...
function divideSquare(a,b,c,d,count){
  if(count > 0){
    ...
    // cd = normalize(bc, true);
    // ac = normalize(ac, true);
    // bd = normalize(bd, true);
    //
    //
    //
    // // divideSquare(a,b,bc,c,count-1);
    // // divideSquare(d,c,bc,b,count-1);
    // // divideSquare(c,a,bc,d,count -1);
    // // divideSquare(b,d,bc,a,count-1);
    var ab = mix( a, b, 0.5);
      var ac = mix( a, c, 0.5);
      var bc = mix( b, c, 0.5);
      var ad = mix( a, d, 0.5);
      ...
      // var ac = mix(a,c,0.5);
      // divideTriangle(a,b,ac,count);
      // divideTriangle(b,d,ac,count);
      // divideTriangle(d,c,ac,count);
      // divideTriangle(a,c,ac,count);
